...
VariablesInteres <- names(data_T1)[37:46]
...
for (z in (1:length(VariablesInteres))){
  ...
  FileOut <- file(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.1_LINEAR_ACELEROM/BMI_LIN_REGR_",Name,".csv"), "w")
  for (i in 1:length(names(MERGED_df_))){
    ...
    if ( pvalu.1 < 0.05 ) {
      ...
      ggsave(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.3_PLOTS_ACELEROM/LINEAR/",names(MERGED_df_)[i],Name,"regression_plot.pdf",sep="_"))
      ...
      ggsave(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.3_PLOTS_ACELEROM/LINEAR/", names(MERGED_df_)[i],Name, "regression_plot_2.pdf", sep="_"), psi)
...
FileOut <- file(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.1_LINEAR_ACELEROM/CATEG_LIN_REGR_",Name,".csv"), "w")
for (i in 1:length(names(MERGED_df_))){
...
#    cat(capture.output(summary(lm1), file="Metabolyc_Syndrome_PGS000308_BMIadj_Fasting_Insulin.txt"))
 ...
 #   odr.1   <- exp(beta.1)
    ...
    if ( pvalu.1 < 0.05 ) {
      ggplotRegression(lm1)
      ggsave(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.3_PLOTS_ACELEROM/LINEAR/CATEG_LIN_",names(MERGED_df_)[i],Name,"regression_plot.pdf",sep="_"))
      psi <- ggstatsplot::ggscatterstats(
        data=nWork,
        x = GRS,
        y = VARIABLE_INTERES,
      ...
      ggsave(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.3_PLOTS_ACELEROM/LINEAR/CATEG_LIN_", names(MERGED_df_)[i],Name, "regression_plot_2.pdf", sep="_"), psi)
...
for (z in (1:length(VariablesInteres))){
  ...
  FileOut <- file(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.2_LOGISTIC_ACELEROM/BLOOD_PRESS_LOG_REGR_",Name,".csv"), "w")
  for (i in 1:length(names(MERGED_df_))){
  ...
  #  cat(capture.output(summary(lm1), file="Metabolyc_Syndrome_PGS000308_BMIadj_Fasting_Insulin.txt"))
    ...
    if ( pvalu.1 < 0.05 ) {
      ...
      ggsave(paste("/mnt/9e33c15a-acae-4445-96c2-5ebe80a1c36a/MIREIA/TFM_REGRESSIONS/2_RESULTS/3_RESULTS_FINAL/3.3_PHYSICAL_ACTIVITY/3.3.3_PLOTS_ACELEROM/LOGISTIC/", names(MERGED_df_)[i],Name,"regression_plot.pdf",sep="_"))
